# Covariance Matrix
I have done another review of the covariance matrices coming from EKF, and here are my conclusions. Let me know what you think.
...
As shown from the code snippet below, the current covariance matrix for the observation in EKF is in polar coordinates:
```
